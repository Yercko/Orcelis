...
public class SignupActivity extends BaseActivity {
    ...
    public boolean validate() {
        ...
        if (name.isEmpty() || name.length() < 3) {
            _nameText.setError(getString(R.string.min_caracteres));
            valid = false;
        } else {
        ...
        if (address.isEmpty()) {
            _addressText.setError(getString(R.string.pais_valido));
            valid = false;
        } else {
        ...
        if (reEnterPassword.isEmpty() || reEnterPassword.length() < 4 || reEnterPassword.length() > 10 || !(reEnterPassword.equals(password))) {
            _reEnterPasswordText.setError(getString(R.string.password_incorrecta));
            valid = false;
        } else {

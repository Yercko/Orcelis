...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final int COLUMNA_EMAIL = 2;
    public static final int COLUMNA_PASSWORD = 3;
    public static final int COLUMNA_UUID = 4;
    public static final int COLUMNA_FECHA_FIN_USO = 5;
    ...
    */
    ...
    private void actualizarDatosLocales(JSONObject response, SyncResult syncResult) {
        ...
        try {
            ...
            gastos = response.getJSONArray(Constantes.USUARIO);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        // Parsear con Gson
